...
# GENERATE_SEED=42
GENERATE_SEED=40
def load_kmnist(ds, batch_size, device, args):
    test_transform = transforms.Compose(
            [transforms.ToTensor(),
            transforms.Normalize((0.5), (0.5))])
    
    temp_train = dsets.KMNIST(root='../../../data/REDGE/', train=True, download=True, transform=transforms.ToTensor())
    temp_valid = dsets.KMNIST(root='../../../data/REDGE/', train=True, transform=test_transform)
    ...
    test_dataset = dsets.KMNIST(root='../../../data/REDGE/', train=False, transform=test_transform)
    ...
    partial_matrix_dataset = KMNIST_Augmentention_K(traindata, partialY.float(), trainlabels.float(), args.augtype, args.augk)
...
class KMNIST_Augmentention_K(Dataset):

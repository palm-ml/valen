...
# GENERATE_SEED=42
GENERATE_SEED=40
def load_fmnist(ds, batch_size, device, args):
    ...
    partial_matrix_dataset = FMNIST_Augmentention_K(traindata, partialY.float(), trainlabels.float(), args.augtype, args.augk)
...
class FMNIST_Augmentention_K(Dataset):

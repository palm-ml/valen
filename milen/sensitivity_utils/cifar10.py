...
# GENERATE_SEED=42
GENERATE_SEED=40
def load_cifar10(ds, batch_size, device, args):
    test_transform = transforms.Compose(
            [transforms.ToTensor(),
            transforms.Normalize((0.4914, 0.4822, 0.4465), (0.247, 0.243, 0.261))])
    
    temp_train = dsets.CIFAR10(root='../../../data/REDGE/', train=True, download=True, transform=transforms.ToTensor())
    temp_valid = dsets.CIFAR10(root='../../../data/REDGE/', train=True, transform=test_transform)
    ...
    test_dataset = dsets.CIFAR10(root='../../../data/REDGE/', train=False, transform=test_transform)
    ...
    partial_matrix_dataset = CIFAR10_Augmentention_K(traindata, partialY.float(), trainlabels.float(), args.augtype, args.augk)
...
class CIFAR10_Augmentention_K(Dataset):

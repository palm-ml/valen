...
# GENERATE_SEED=42
GENERATE_SEED=40
def load_mnist(ds, batch_size, device, args):
    test_transform = transforms.Compose(
            [transforms.ToTensor(),
            transforms.Normalize((0.1307), (0.3081))])
    
    temp_train = dsets.MNIST(root='/home/qiaocy/data/REDGE/', train=True, download=True, transform=transforms.ToTensor())
    temp_valid = dsets.MNIST(root='/home/qiaocy/data/REDGE/', train=True, transform=test_transform)
    ...
    test_dataset = dsets.MNIST(root='/home/qiaocy/data/REDGE/', train=False, transform=test_transform)
    ...
    partial_matrix_dataset = MNIST_Augmentention(traindata, partialY.float(), trainlabels.float(), args.waugk)
...
class MNIST_Augmentention(Dataset):

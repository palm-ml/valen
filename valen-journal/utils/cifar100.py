...
# GENERATE_SEED=42
GENERATE_SEED=40
def load_cifar100(ds, batch_size, device):
    test_transform = transforms.Compose(
            [transforms.ToTensor(),
            transforms.Normalize((0.4914, 0.4822, 0.4465), (0.247, 0.243, 0.261))])
    
    temp_train = dsets.CIFAR100(root='/home/qiaocy/data/REDGE/', train=True, download=True, transform=transforms.ToTensor())
    temp_valid = dsets.CIFAR100(root='/home/qiaocy/data/REDGE/', train=True, transform=test_transform)
    ...
    test_dataset = dsets.CIFAR100(root='/home/qiaocy/data/REDGE/', train=False, transform=test_transform)

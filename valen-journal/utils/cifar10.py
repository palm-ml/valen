...
def load_cifar10(ds, batch_size, device):
    ...
    temp_train = dsets.CIFAR10(root='/home/qiaocy/data/REDGE/', train=True, download=True, transform=transforms.ToTensor())
    temp_valid = dsets.CIFAR10(root='/home/qiaocy/data/REDGE/', train=True, transform=test_transform)

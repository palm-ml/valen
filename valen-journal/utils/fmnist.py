...
GENERATE_SEED=42
# GENERATE_SEED=40
def load_fmnist(ds, batch_size, device):
    test_transform = transforms.Compose(
            [transforms.ToTensor(),
            transforms.Normalize((0.1307), (0.3081))])
    
    temp_train = dsets.FashionMNIST(root='/home/qiaocy/data/REDGE/', train=True, download=True, transform=transforms.ToTensor())
    temp_valid = dsets.FashionMNIST(root='/home/qiaocy/data/REDGE/', train=True, transform=test_transform)
    ...
    test_dataset = dsets.FashionMNIST(root='/home/qiaocy/data/REDGE/', train=False, transform=test_transform)

...
class cifar10(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        """
        if self.train:
            img, target, final, true, distr = self.train_data[index], self.train_targets[index], self.train_final_labels[index], self.train_labels[index], self.train_label_distribution[index]
        else:
            img, target, final, true, distr = self.test_data[index], self.test_labels[index], self.test_labels[index], self.test_labels[index], self.test_labels[index]
        ...
        return img, target, final, true, distr, index
